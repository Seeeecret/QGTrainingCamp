...
![1571652681276](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571652681276.png) 
...
![1571732060388](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571732060388.png) 
...
![1571735388181](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571735388181.png) 
...
![1571735607347](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571735607347.png) 
...
![1571735715977](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571735715977.png) 
...
![1571735904991](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571735904991.png) 

此时3个任务都以及提交完毕，断点跳过。经过20s以后，再次查看该进程中的线程。

![1571736824748](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571736824748.png) 
...
![1571743818653](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571743818653.png) 

## 3.3 问题分析

​	了解了一下JMM,那么接下来我们就来分析一下上述程序产生问题的原因。

![1571744627663](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571744627663.png)  
...
![1571746088704](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571746088704.png) 
...
![1571794778139](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571794778139.png) 
...
![1571817059527](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571817059527.png)  

2. 此时线程1想要把变量的值增加1。对线程1来说，旧的预期值 A = 10 ，要修改的新值 B = 11。

![1571817085047](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571817085047.png) 

3. 在线程1要提交更新之前，另一个线程2抢先一步，把内存值V中的变量值率先更新成了11。

![1571817628904](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571817628904.png) 

4. 线程1开始提交更新，首先进行A和内存值V的实际值比较（Compare），发现A不等于V的值，提交失败。

![1571818176635](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571818176635.png) 

5. 线程1重新获取内存值V作为当前A的值，并重新计算想要修改的新值。此时对线程1来说，A = 11，B = 12。这个重新尝试的过程被称为<font color="red" size="4">**自旋**</font>。

![1571818465276](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571818465276.png) 

6. 这一次比较幸运，没有其他线程改变V的值。线程1进行Compare，发现A和V的值是相等的。

![1571818597998](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571818597998.png) 

7. 线程1进行SWAP，把内存V的值替换为B，也就是12。

![1571818747880](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571818747880.png) 
...
![1571905221097](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571905221097.png) 
...
![1571880094854](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571880094854.png)  
...
![1571901607504](https://mytyporapicute.oss-cn-guangzhou.aliyuncs.com/typoraPics/1571901607504.png) 
